...
public class U1G4_addServiceNotesViewController
{
    @javafx.fxml.FXML
    ...
    @javafx.fxml.FXML
    private TextArea serviceNoteTextArea;
    ...
    private void loadTV(){
        ...
        for(JobCard j : jobCardArrayList){
            if(j.getTechnicianID().equals(technicianID) && j.getStatus().equals("In Progress")){
